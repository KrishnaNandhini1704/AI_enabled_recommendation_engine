...
|:---|:---|:---|:---|:---|:---|
| **TECH-01** | UI Refinement: Recs Page | High | Replace the string return in `/recommendations` with a modern Glassmorphism template consistent with the Index page. | 3 pts | Done |
